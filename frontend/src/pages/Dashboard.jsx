...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen bg-slate-900 text-white p-6">
      <div className="w-1/4 bg-slate-800 p-4 rounded-xl mr-6">
      ...
      <div className="flex-1 flex gap-4 overflow-x-auto">
        <DndContext collisionDetection={closestCenter}>
          {routes.map(route => (
            <div key={route.id} className="w-80 bg-slate-700 p-4 rounded-xl">
